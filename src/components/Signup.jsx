...
import {registerationRequest,registerationSuccess,registerationFail} from './../redux/booking/actions'
...
class Signup extends React.Component{
    ...
    handleRegister=()=>{
        const {registerationRequest,registerationSuccess,registerationFail}=this.props
    ...
    render(){
        return(
            ...
            <img className="img-fluid col" src="https://i.dlpng.com/static/png/268615_preview.png" alt=""/>
                ...
                <input onChange={this.handleChange} className="my-1" type="text" name="location" id="" placeholder="location"/>
                <button onClick={this.handleRegister} type="button" className="btn btn-primary mt-2">Register</button>
            </div>
