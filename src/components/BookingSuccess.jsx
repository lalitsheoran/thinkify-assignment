...
class BookingSuccess extends React.Component {
  ...
  componentDidMount() {
    ...
    let filteredBooking = filteredUser.bookings.filter(
      (e) => e.bookingId == latestBookingId
    )[0];
    this.setState({
  ...
  render() {
    ...
    return (
      <>
        <div>
          <p className="display-2 text-center text-white bg-danger">
            Booking Successfull
          </p>
          ...
          <p className="h4 text-center">
            If you booked it by mistake, cancel it right now.
          </p>
